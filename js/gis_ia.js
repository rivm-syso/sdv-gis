	...
	switch (this.t) {
		...
		case 'vt': // van - tot
			...
			if (this.l1=='') {
				...
				r+='<div class="gis_ia_input gis_ia_input50"><div><select id="'+this.ID()+'-van" class="gis_ia_input" onchange="gis_ia_filters.change('+this.map_id+',\''+this.ID()+'\',0);" placeholder="'+this.v1+'">'+opts+'</select><span>'+this.x_button(2)+'</span></div></div>';
			}
			if (this.l2=='') {
				...
				r+='<div class="gis_ia_input gis_ia_input50"><div><span class="gis_ia_filters_arrow_down"></span><select id="'+this.ID()+'-tot" class="gis_ia_input" onchange="gis_ia_filters.change('+this.map_id+',\''+this.ID()+'\',1);" placeholder="'+this.v2+'">'+opts+'</select><span>'+this.x_button(2)+'</span></div></div>';
			}
			r+='</div>';
			break;
	}
