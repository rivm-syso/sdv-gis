...
function getFilterDefTableItem(f,i,opts) {
	...
	switch (f.t) {
		...
		case 'd': // list
			...
			s+='<div style="display: inline-block;">Labels<br><textarea rows="6" cols="20" placeholder="Voer voor elke waarde'+String.fromCharCode(13)+'een label in, bv:'+String.fromCharCode(13)+'Oud'+String.fromCharCode(13)+'Jong" onchange="gis_ia_set_filterItem(this,\''+i+'\',\'w\');">'+f.w+'</textarea></div>&nbsp;';
			s+='<div style="display: inline-block;">Waarden<br><textarea rows="6" cols="20" placeholder="Bij operator ='+String.fromCharCode(13)+'kun je bv opgeven:'+String.fromCharCode(13)+'20'+String.fromCharCode(13)+'En bij operator range:'+String.fromCharCode(13)+'>=0 <=20'+String.fromCharCode(13)+'>=20 <=100" onchange="gis_ia_set_filterItem(this,\''+i+'\',\'v\');">'+f.v+'</textarea></div></div></td>';
