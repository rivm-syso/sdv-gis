...
//	start_el.prepend('<div class="button" style="float: right;margin: 12px 60px 12px 20px;" onclick="window.open(\''+href+'\',\'gis_ia_help\');">Help</div>');
	...
	d+='<div class="form-item-start">';
	// links boven
		d+='<div class="kolom_3"><div>Positie data-window:</div><div><select gis_ia="w1"><option value="0">Rechts boven muisklik, binnen de kaart</option><option value="1">Indien mogelijk onder de muisklik en over de pagina</option></select></div></div>';
