...
function getFilterDefTableItem(f,i,opts) {
	...
	switch (f.t) {
		...
		case 'd': // list
			...
			s+='<div style="display: inline-block;">Labels<br><textarea rows="6" cols="20" placeholder="\'=\''+String.fromCharCode(9)+'Wonen'+String.fromCharCode(13)+String.fromCharCode(9)+'Agrarisch'+String.fromCharCode(13)+String.fromCharCode(9)'Industrie'+String.fromCharCode(13)+'\'range\''+String.fromCharCode(9)+'Jong'+String.fromCharCode(13)+String.fromCharCode(9)+'Gemiddeld'+String.fromCharCode(13)+String.fromCharCode(9)+'Oud" onchange="gis_ia_set_filterItem(this,\''+i+'\',\'w\');">'+f.w+'</textarea></div>&nbsp;';
			s+='<div style="display: inline-block;">Waarden<br><textarea rows="6" cols="20" placeholder="\'=\''+String.fromCharCode(9)+'1'+String.fromCharCode(13)+String.fromCharCode(9)+'2'+String.fromCharCode(13)+String.fromCharCode(9)+'3'+String.fromCharCode(13)+'\'range\''+String.fromCharCode(9)+'<20'+String.fromCharCode(13)+String.fromCharCode(9)+'>=20 <70'+String.fromCharCode(13)+String.fromCharCode(9)+'>=70" onchange="gis_ia_set_filterItem(this,\''+i+'\',\'v\');">'+f.v+'</textarea></div></div></td>';
