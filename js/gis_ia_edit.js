...
function getFilterDefTableItem(f,i,opts) {
	...
	switch (f.t) {
		...
		case 'd': // list
			...
			s+='<div style="display: inline-block;">Labels<br><textarea rows="6" cols="20" placeholder="\'=\'     '+String.fromCharCode(13)+'        Wonen'+String.fromCharCode(13)+'        Agrarisch'+String.fromCharCode(13)+'        Industrie'+String.fromCharCode(13)+'\'range\' Jong'+String.fromCharCode(13)+'        Gemiddeld'+String.fromCharCode(13)+'        Oud" onchange="gis_ia_set_filterItem(this,\''+i+'\',\'w\');">'+f.w+'</textarea></div>&nbsp;';
