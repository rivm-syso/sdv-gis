...
function getFilterDefTableItem(f,i,opts) {
	...
	switch (f.t) {
		...
		case 'i': // vrije tekst
			...
			s+='</td><td></td><td><input type="button" onclick="gis_ia_toggle_filters(this);" value="klik"></td><td></td><td><div style="white-space: nowrap;" class="gis_ia_hideable">Placeholder: <input value="'+f.p+'" onchange="gis_ia_set_filterItem(this,\''+i+'\',\'p\');"><br><input type="checkbox" '+(f.x0=='1'?'checked="checked" ':'')+'onchange="gis_ia_set_filterItem(this,\''+i+'\',\'x0\');" id="gis_ia_f_'+i+'x0"><label for="gis_ia_f_'+i+'x0"> X-button bovenaan</label><br><input type="checkbox"'+(f.x1=='1'?'checked="checked" ':'')+'onchange="gis_ia_set_filterItem(this,\''+i+'\',\'x1\');" id="gis_ia_f_'+i+'x1"><label for="gis_ia_f_'+i+'x1"> X-button in hoofdgroep</label><br><input type="checkbox"'+(f.x2=='1'?'checked="checked" ':'')+'onchange="gis_ia_set_filterItem(this,\''+i+'\',\'x2\');" id="gis_ia_f_'+i+'x2"><label for="gis_ia_f_'+i+'x2"> X-button in place</label></div>';
